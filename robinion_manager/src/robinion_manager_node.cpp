...
{
    ros::init(argc, argv, "robinion_manager");
    ros::NodeHandle nh;
    ...
    // controller->addMotionModule((MotionModule*) OP3MotionModule::getInstance());
    // controller->addMotionModule((MotionModule*) MotionModuleTutorial::getInstance());
